...
const testimonials = [
  {
    ...
    country: 'Nigeria',
    testimonial: 'The International Ministers Forum Africa has been instrumental in transforming ministry across our continent. Their training programs have strengthened our pastoral capacity and enabled us to establish over 5,000 ministry centers across Africa in the past three years alone.',
    impact: 'Led to 5,000+ ministry centers and 2M+ souls won',
    rating: 5,
...

  {
    ...
    country: 'Ghana',
    testimonial: 'IMF Africa\'s strategic approach to ministry development has been transformational. Their training frameworks have helped our ministry network make informed decisions that have collectively established over 1,000 ministry centers across West Africa in five years.',
    impact: 'Established 1,000+ ministry centers across West Africa',
    rating: 5,
