...
const testimonials = [
  ...
  {
    id: 3,
    name: 'Rev. Dr. Helen Berhane',
    position: 'Founder & President',
    organization: 'Sound of Hope Ministries',
    country: 'Ethiopia',
    testimonial: 'The Women in Ministry program would not have been possible without the support and training provided by IMF Africa. Their empowerment initiatives helped us design programs that have raised up over 3,000 women leaders across East Africa.',
    impact: 'Empowered 3,000+ women in ministry leadership',
    rating: 5,
    program: 'Women in Ministry',
    avatar: '/api/placeholder/80/80',
  ...
  },
  {
    ...
    organization: 'Deeper Christian Life Ministry',
    country: 'Nigeria',
    testimonial: 'The Church Planting Initiative opened doors we never thought possible. IMF Africa\'s strategic approach helped us expand our ministry to over 120 countries, bringing the Gospel to unreached communities across Africa and beyond.',
    impact: 'Reached 120+ countries with the Gospel',
    rating: 5,
    program: 'Church Planting',
    avatar: '/api/placeholder/80/80',
